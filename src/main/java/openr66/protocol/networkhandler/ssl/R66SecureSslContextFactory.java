...
/**
 * R66SecureSslContextFactory for SSL
 *
 ...
 *
 */
public class R66SecureSslContextFactory {
    /**
     * Internal Logger
     */
    private static final GgInternalLogger logger = GgInternalLoggerFactory
            .getLogger(R66SecureSslContextFactory.class);
    ...
    static {
        ...
        try {
            ...
            serverContext.init(R66SecureKeyStore.keyManagerFactory.getKeyManagers(),
                    R66SecureTrustManagerFactory.getTrustManagers(), null);
        } catch (Exception e) {

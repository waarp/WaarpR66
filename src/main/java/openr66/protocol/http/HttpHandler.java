...
public class HttpHandler extends SimpleChannelUpstreamHandler {
    ...
    private void startHeader() {
        ...
        responseContent
                .append("<title>OpenR66 Web Information Server</title>\r\n");
    }
    ...
    private void inlineHeader() {
        responseContent
                .append("<noscript><meta http-equiv='refresh' content=11></noscript>");
        responseContent.append("<script language='JavaScript'><!--\r\n");
        responseContent
                .append("var sURL = unescape(window.location.pathname);");
        responseContent
                .append("function doLoad(){setTimeout( 'refresh()', 10000 );}");
        responseContent
                .append("function refresh(){window.location.href = sURL;}");
        responseContent.append("//-->\r\n</script>\r\n");
        responseContent.append("<script language='JavaScript1.1'><!--\r\n");
        responseContent
                .append("function refresh(){window.location.replace( sURL );}");
        responseContent.append("//-->\r\n</script>\r\n");
        responseContent.append("<script language='JavaScript1.2'><!--\r\n");
        responseContent
                .append("function refresh(){window.location.reload( false );}");
        responseContent.append("//-->\r\n</script>\r\n");
    }
    ...
    private void createMenu() {
        ...
        responseContent.append("<FORM ACTION=\"" + uriRequest +
                "\" METHOD=\"GET\">");
        responseContent.append("<input type=hidden name=" + sCOMMAND +
                " value=\"GET\">");
        responseContent.append("<table border=\"0\">");
        responseContent
                .append("<tr><td>One Choice 0=Active 1=Error 2=Done 3=All: <br> <input type=text name=\"" +
                        sINFO + "\" size=1></td></tr>");
        responseContent
                .append("<tr><td>Number of runners (0 for all): <br> <input type=text name=\"" +
                        sNB + "\" size=5>");

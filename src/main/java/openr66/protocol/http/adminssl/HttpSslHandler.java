...
public class HttpSslHandler extends SimpleChannelUpstreamHandler {
	...
	private static enum REQUEST {
		...
		public String readBodyHeader() {
			return GgStringUtils.readFile(Configuration.configuration.httpBasePath
					+ this.headerBody);
		}
		...
		if (parms != null) {
			...
			if ("Create".equalsIgnoreCase(parm)) {
				...
				try {
					...
					body0 = body1 = body = "";
					body = "<p><center><b>Cannot create a Host: " + e1.getMessage()
							+ "</b></center></p>";
					head = resetOptionHosts(head, "", "", false);
					return head + body0 + body + body1 + end;
				}
				...
				try {
					...
					body0 = body1 = body = "";
					body = "<p><center><b>Cannot Update a Host: " + e1.getMessage()
							+ "</b></center></p>";
					head = resetOptionHosts(head, "", "", false);
					return head + body0 + body + body1 + end;
				}
				...
				try {
					...
					body0 = body1 = body = "";
					body = "<p><center><b>Cannot find a Host: " + e1.getMessage()
							+ "</b></center></p>";
					head = resetOptionHosts(head, "", "", false);
					return head + body0 + body + body1 + end;
				}

...
public class TestSendThroughForward extends SendThroughClient {
	...
	public static class TestRecvThroughForwardHandler extends RecvThroughHandler {
		 ...
		 * (non-Javadoc)
		 * @see
		 * openr66.client.RecvThroughHandler#writeChannelBuffer(org.jboss.netty.buffer.ChannelBuffer
		 * )
		 */
		@Override
	 ...
	 * (non-Javadoc)
	 * @see
	 * openr66.client.SendThroughClient#transferInError(openr66.protocol.exception.OpenR66Exception)
	 */
	@Override

...
import static openr66.context.R66FiniteDualStates.AUTHENTD;
import static openr66.context.R66FiniteDualStates.AUTHENTR;
import static openr66.context.R66FiniteDualStates.CLOSEDCHANNEL;
import static openr66.context.R66FiniteDualStates.DATAR;
import static openr66.context.R66FiniteDualStates.ENDREQUESTR;
import static openr66.context.R66FiniteDualStates.ENDREQUESTS;
import static openr66.context.R66FiniteDualStates.ENDTRANSFERR;
import static openr66.context.R66FiniteDualStates.ENDTRANSFERS;
import static openr66.context.R66FiniteDualStates.ERROR;
import static openr66.context.R66FiniteDualStates.INFORMATION;
import static openr66.context.R66FiniteDualStates.REQUESTD;
import static openr66.context.R66FiniteDualStates.REQUESTR;
import static openr66.context.R66FiniteDualStates.SHUTDOWN;
import static openr66.context.R66FiniteDualStates.STARTUP;
import static openr66.context.R66FiniteDualStates.TEST;
import static openr66.context.R66FiniteDualStates.VALID;
import static openr66.context.R66FiniteDualStates.VALIDOTHER;
			...
			if (exception instanceof OpenR66ProtocolShutdownException) {
				...
				if (exception instanceof OpenR66ProtocolNoConnectionException) {
					...
					if (runner != null) {
						R66Result finalValue = new R66Result(
								new OpenR66ProtocolSystemException(
										"Finalize too early at close time"),

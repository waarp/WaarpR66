...
import goldengate.snmp.r66.GgPrivateMib.MibLevel;
		...
		synchronized (trafficCounter) {
			...
			try {
				...
				if (detail) {
					...
					DbTaskRunner
							.finishSelectOrCountPrepareStatement(countTransferOkStep, limitDate);
					...
					DbTaskRunner
							.finishSelectOrCountPrepareStatement(countCompleteOkStep, limitDate);

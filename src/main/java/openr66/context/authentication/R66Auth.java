...
public class R66Auth extends FilesystemBasedAuthImpl {
	...
	/*
	 * (non-Javadoc)
	 * @seegoldengate.common.file.filesystembased.FilesystemBasedAuthImpl# getBaseDirectory()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @seegoldengate.common.file.filesystembased.FilesystemBasedAuthImpl# setBusinessRootFromAuth()
	 */
	@Override

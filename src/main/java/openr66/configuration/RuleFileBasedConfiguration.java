...
public class RuleFileBasedConfiguration {
	...
	private static final XmlDecl[] multipleruleDecls = {
			new XmlDecl(MULTIPLEROOT, XmlType.XVAL, "/" + MULTIPLEROOT + "/" + ROOT, subruleDecls,
					true)
	};
	...
	public static DbRule getFromFile(File file)
			throws OpenR66ProtocolSystemException, GoldenGateDatabaseNoConnectionError,
	 ...
	 * @throws OpenR66ProtocolSystemException
	 */
	public static void writeXml(String directory, String hostname)

...
public class Transfer {
    ...
    public Transfer(long id, String rule, int mode, String filename,
            ...
            int blockSize, boolean isSender, String ownerReq, String requester,
    ...
    public Transfer(String rule, int rulemode, boolean isSender, String file, String fileName,
            int blockSize) {
        this(DbConstant.ILLEGALVALUE, rule, rulemode, file, file, "", false, 
                blockSize, isSender, "", "", "", "", TASKSTEP.NOTASK, 
                TASKSTEP.NOTASK, -1, "", "", 0, 

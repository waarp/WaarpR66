...
public class R66Auth extends FilesystemBasedAuthImpl {
    ...
    /**
     * connection from HTTPS (no default rights, must be set either as admin or specifically through
     * ROLEs). Only "false client" with port with negative values are allowed.
     * 
     * @param dbSession
     * @param hostId
     * @param arg0

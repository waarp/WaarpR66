 ...
 * In case of error, if the output finishes with <tt>NEWFINALNAME:xxx</tt> then this part is removed
 * from the output and the xxx is used as the last valid name for the file (meaning the file was
 * moved or renamed even in case of error)<br>
 * <br>
 * 

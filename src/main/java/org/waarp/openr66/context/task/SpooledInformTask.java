...
public class SpooledInformTask extends AbstractExecJavaTask {
     ...
     * @param uri
     * @return the StringBuilder containing the HTML format as a Table of the current Spooled
     *         information
     */
    ...
    private static StringBuilder beginSpooledTable(boolean detailed, String uri) {
        StringBuilder builder = new StringBuilder("<TABLE BORDER=1><CAPTION><A HREF=").append(uri);
        if (detailed) {
    ...
    private static void buildSpooledTableFiles(StringBuilder builder, SpooledInformation inform) {
        builder.append("<TABLE BORDER=1><TR><TH>")
                .append(Messages.getString("SpooledInformTask.10")) //$NON-NLS-1$
                .append("</TH><TH>")
                .append(Messages.getString("SpooledInformTask.11")) //$NON-NLS-1$
                .append("</TH><TH>")

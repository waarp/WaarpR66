...
public enum R66FiniteDualStates {
    ...
    private enum R66Transition {
        ...
        tAUTHENTD(AUTHENTD, EnumSet.of(REQUESTR, VALIDOTHER, INFORMATION, SHUTDOWN, TEST, BUSINESSR, BUSINESSD, ENDREQUESTS, CLOSEDCHANNEL, ERROR)),
        tREQUESTR(REQUESTR, EnumSet.of(VALID, REQUESTD, CLOSEDCHANNEL, ERROR)),
        tREQUESTD(REQUESTD, EnumSet.of(DATAS, DATAR, CLOSEDCHANNEL, ERROR)),

...
public class HttpRestR66Client extends HttpRestClientHelper {
     ...
     * @param json
     *            json to send as body in the request (might be null); Useful in PUT, POST but
     ...
     *            the associated pipelineFactory including the REST handler for client side
     * @param client
     ...
     * 
     * @param bodyResponse
     * @return the primary property value associated with the Model (from the bodyResponse), else
     *         null
     */

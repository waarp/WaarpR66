...
public final class TransfersDatabase {
    ...
    private static List<Transfer> initTransfersDb() {
        ...
        transfer2.startTrans = new GregorianCalendar(2018, 1, 1, 0, 0, 1);
        ...
        transfer3.startTrans = new GregorianCalendar(2017, 1, 1, 0, 0, 1);
        ...
        transfer4.startTrans = new GregorianCalendar(2017, 6, 1, 0, 0, 1);
        ...
        transfer5.startTrans = new GregorianCalendar(2018, 6, 1, 0, 0, 1);

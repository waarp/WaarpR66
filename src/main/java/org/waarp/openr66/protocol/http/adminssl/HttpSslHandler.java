...
public class HttpSslHandler extends SimpleChannelUpstreamHandler {
    ...
    private static enum REQUEST {
        ...
        public String readBodyHeader() {
            return WaarpStringUtils.readFile(Configuration.configuration.httpBasePath+this.headerBody);
        }
        public String readBody() {
            return WaarpStringUtils.readFile(Configuration.configuration.httpBasePath+this.body);
        }
        public String readBodyEnd() {
            return WaarpStringUtils.readFile(Configuration.configuration.httpBasePath+this.endBody);
        }
    ...
    private void checkAuthent(MessageEvent e) {
        ...
        if (params.containsKey("Logon")) {
            ...
            if (! getMenu) {
                logger.debug("Name="+name+" vs "+name.equals(Configuration.configuration.ADMINNAME)+
    ...
    private void writeResponse(Channel channel) {
        ...
        ChannelBuffer buf = ChannelBuffers.copiedBuffer(responseContent.toString(), WaarpStringUtils.UTF8);
    ...
    private void sendError(ChannelHandlerContext ctx, HttpResponseStatus status) {
        ...
        response.setContent(ChannelBuffers.copiedBuffer(responseContent.toString(), WaarpStringUtils.UTF8));
        clearSession();

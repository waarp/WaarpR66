 ...
 * Request class
 * 
 * header = "rulename MODETRANS" middle =
 * way+"FILENAME BLOCKSIZE RANK specialId code (optional length)" end = "fileInformation"
 * 
 * or
 * 
 * header = "{rule:rulename, mode:MODETRANS}" middle = way{filename:FILENAME, block:BLOCKSIZE,
 * rank:RANK, id:specialId, code:code, length:length}" end = "fileInformation"
 * 

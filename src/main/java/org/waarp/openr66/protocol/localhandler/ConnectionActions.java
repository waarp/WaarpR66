...
/**
 * Class to implement actions related to general connection handler: channelClosed, startup,
 * authentication, and error. Used to store and retrieve the session information.
 * 

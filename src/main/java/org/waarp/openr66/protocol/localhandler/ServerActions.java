 ...
 * configuration import/export, log purge, request restart/stop/cancel, business request, block new
 * request control, information request and transfer request.
 * 
...
public class ServerActions extends ConnectionActions {
    ...
    public final long[] bandwidth(boolean setter,
        ...
        if (!setter) {
            // request of current values
            // Now answer
            return new long[] { Configuration.configuration.serverGlobalWriteLimit,
     ...
     * @return the ValidPacket to answer containing: File Listing as Header and Number of entries as
     *         Middle
     * @throws OpenR66ProtocolNotAuthenticatedException
     * @throws OpenR66ProtocolNoDataException
     * @throws OpenR66ProtocolPacketException
     ...
     * @param remoteHost
     *            requester/requested for transfer if jsonOutput is True, else (jsonOutput False)

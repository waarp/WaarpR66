 ...
 *
 */
public class R66TransferExecutor implements Runnable {
    /**
     * Internal Logger
     */
    private static final GgInternalLogger logger = GgInternalLoggerFactory
            .getLogger(R66TransferExecutor.class);
     ...
     * R66Transfer
     */
    private final R66Transfer executeTransfer;
     ...
     */
    public R66TransferExecutor(FtpSession session, R66Transfer executeTransfer) {

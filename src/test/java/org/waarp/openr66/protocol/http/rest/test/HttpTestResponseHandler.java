 ...
 * validated once all items are passed in a chain. In normal condition, each step should produce:
 * setting the RestArgument to the RestFuture and validating (error or ok) to RestFuture.
 * 

    ...
    protected boolean action(Channel channel, RestArgument ra, ACTIONS_TYPE act) {
    	...
    	switch (act) {
			case CreateTransfer: {
				...
				try {
					recv = (TransferRequestJsonPacket) JsonPacket.createFromBuffer(JsonHandler.writeAsString(ra.getResults().get(0)));
				} catch (Exception e) {
			...
			case RestartTransfer: {
				...
				try {
					recv = (RestartTransferJsonPacket) JsonPacket.createFromBuffer(JsonHandler.writeAsString(ra.getResults().get(0)));
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
					return newMessage;
				...
				try {
					HttpTestRestR66Client.deleteData(channel, recv.getRequested(), recv.getRequester(), recv.getSpecialid());
			...
			case SetBandwidth: {
				...
				try {
					recv = (BandwidthJsonPacket) JsonPacket.createFromBuffer(JsonHandler.writeAsString(ra.getResults().get(0)));
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
					return newMessage;
			...
			case StopOrCancelTransfer: {
				...
				try {
					recv = (StopOrCancelJsonPacket) JsonPacket.createFromBuffer(JsonHandler.writeAsString(ra.getResults().get(0)));
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
					return newMessage;

...
public class TestSendThroughForward extends SendThroughClient {
    ...
    public static class TestRecvThroughForwardHandler extends RecvThroughHandler {
        ...
        /* (non-Javadoc)
         * @see org.waarp.openr66.client.RecvThroughHandler#writeChannelBuffer(org.jboss.netty.buffer.ChannelBuffer)
         */
        @Override
    ...
    /* (non-Javadoc)
     * @see org.waarp.openr66.client.SendThroughClient#transferInError(org.waarp.openr66.protocol.exception.OpenR66Exception)
     */
    @Override
